...
angular.module('app.controllers', [])
  ...
  .controller('SelfieController', ['$scope', '$ionicPlatform', '$cordovaCamera', '$cordovaToast', '$cordovaDevice', function ($scope, $ionicPlatform, $cordovaCamera, $cordovaToast, $cordovaDevice) {
    $ionicPlatform.ready(function() {
